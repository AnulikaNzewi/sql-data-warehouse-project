...
-- INSERT THE STANDARDIZED DATA INTO THE SILVER LAYER Crm_info
...
-- crm_prd_info
SET @start_time = GETDATE();
-- Insert Cleaned Data Into the Silver Layer (prd_info)
...
-- crm_sales_details
SET @start_time = GETDATE();
	-- Insert Clean and standardized data into crm_sales_details
...
SET @start_time = GETDATE();
	...
	-- Insert Clean and standardized data into erp_cust_az12
...
-- erp_loc_a101
SET @start_time = GETDATE();
-- Insert Clean and standardized data into silver layer erp_loc_a10
...
-- erp_px_cat_g1v2
SET @start_time = GETDATE();
	-- Load Clean & Data nto Silver Layer erp_px_cat_g1v2
